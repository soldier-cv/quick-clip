...
public sealed class ThemePalette
{
    ...
    public static ThemePalette Terminal { get; } = new()
    {
        ...
        Card = Rgb(0x26, 0x26, 0x26),
        // 相对 Card 明显抬一档（非 +6 灰阶）
        CardHover = Rgb(0x3A, 0x3A, 0x3A),
        // 墨绿底（配合 Accent 绿边框）
        CardSelected = Rgb(0x1A, 0x2E, 0x22),
        Border = Rgb(0x38, 0x38, 0x38),
        BorderStrong = Rgb(0x5A, 0x5A, 0x5A),
        Text = Rgb(0xE8, 0xE8, 0xE8),
        TextSecondary = Rgb(0x9A, 0x9A, 0x9A),
        TextMuted = Rgb(0x6B, 0x6B, 0x6B),
        Accent = Rgb(0x3F, 0xB9, 0x50),
        AccentMuted = Rgba(0x3F, 0xB9, 0x50, 0x33),
        Pin = Rgb(0xD4, 0xA0, 0x17),
        Search = Rgb(0x2A, 0x2A, 0x2A),
        Badge = Rgb(0x3A, 0x3A, 0x3A)
    };
    ...
    public static ThemePalette FluentIndigo { get; } = new()
    {
        ...
        CardHover = Rgb(0x2C, 0x38, 0x52),
        CardSelected = Rgb(0x20, 0x22, 0x4A),
        Border = Rgb(0x2A, 0x35, 0x48),
        ...
        Search = Rgb(0x1A, 0x22, 0x34),
        Badge = Rgb(0x2A, 0x30, 0x55)
    };
    ...
    public static ThemePalette Nord { get; } = new()
    {
        ...
        CardHover = Rgb(0x50, 0x5B, 0x70),
        CardSelected = Rgb(0x36, 0x4C, 0x56),
        ...
        Search = Rgb(0x43, 0x4C, 0x5E),
        Badge = Rgb(0x4C, 0x56, 0x6A)
    };
    ...
    public static ThemePalette Catppuccin { get; } = new()
    {
        ...
        CardHover = Rgb(0x48, 0x4A, 0x5E),
        CardSelected = Rgb(0x34, 0x2A, 0x4C),
        ...
        Search = Rgb(0x31, 0x32, 0x44),
        Badge = Rgb(0x45, 0x47, 0x5A)
    };
    ...
    public static ThemePalette OneDark { get; } = new()
    {
        ...
        Card = Rgb(0x2C, 0x31, 0x3A),
        CardHover = Rgb(0x40, 0x47, 0x55),
        CardSelected = Rgb(0x22, 0x32, 0x44),
        ...
        Search = Rgb(0x2C, 0x31, 0x3A),
        Badge = Rgb(0x3E, 0x44, 0x51)
    };
